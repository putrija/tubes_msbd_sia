            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="id_card_guru" name="id_card_guru" maxlength="5" onkeypress="return inputAngka(event)" value="{{ $id_card_guru }}" class="form-control @error('id_card_guru') is-invalid @enderror" readonly>
                    </div>
                    <div class="form-group">
