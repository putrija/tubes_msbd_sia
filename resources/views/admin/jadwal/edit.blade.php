        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label for="guru_mengajar_id">Kode Mapel</label>
                <select id="guru_mengajar_id" name="guru_mengajar_id" class="form-control @error('guru_mengajar_id') is-invalid @enderror select2bs4">
                  <option value="" @if ($jadwal->guru_mengajar_id)
                    selected
                  @endif>-- Pilih Guru --</option>
                  @foreach ($guru as $data)
                    <option value="{{ $data->id }}"
                      @if ($jadwal->guru_mengajar_id == $data->id)
                        selected
                      @endif
                    >{{ $data->nama_guru }}-{{ $data->nama_mapel }}</option>
                  @endforeach
                </select>
              </div>
            </div>
