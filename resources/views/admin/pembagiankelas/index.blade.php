                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('kelas.destroy', $data->nama_siswa) }}" method="post">
                            @csrf
                            @method('delete')
                            <button type="button" class="btn btn-info btn-sm" onclick="getSubsSiswa({{$data->nama_siswa}})" data-toggle="modal" data-target=".view-siswa">
                              <i class="nav-icon fas fa-users"></i> &nbsp; View Siswa
                            </button>
                            <button type="button" class="btn btn-info btn-sm" onclick="getSubsJadwal({{$data->nama_siswa}})" data-toggle="modal" data-target=".view-jadwal">
